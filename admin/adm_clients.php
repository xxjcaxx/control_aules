...
$res = exec('sudo ssh -o "UserKnownHostsFile=/dev/null" -o "ConnectTimeout=10" -o "StrictHostKeyChecking no" root@'.$prefijo.'.'.$_GET['ip'].' \'bash -s\' < ./scripts/captures.sh > /var/lib/control_aules/captura'.$_GET['ip'].'.jpg' );
           echo $res;
