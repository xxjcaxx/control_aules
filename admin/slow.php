...
$res = exec('sudo iptables -I FORWARD -m hashlimit --hashlimit-above '.$vel.'kb/sec --hashlimit-burst '.$burst.'mb --hashlimit-mode srcip,dstip --hashlimit-name bwlimit -j DROP');
